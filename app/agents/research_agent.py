...
"""
Research Agent - Complete implementation in one file
Literary Research Specialist for educational story adaptations
"""
...
class WorkingResearchAgent:
    """Research agent that calls tools directly with smart prompt processing"""
...
# Create the main agent instance that everyone imports
content_research_agent = WorkingResearchAgent()

# For backwards compatibility, also export with different names
research_agent = content_research_agent
working_research_agent = content_research_agent
